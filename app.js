...
var mongoUrl = 'mongodb+srv://testuser:testuser@cluster0.2c95k.mongodb.net/foodiez?retryWrites=true&w=majority';
...
// first default route
app.get('/',(req,res) => {
    res.send("Hiii From Express hello")
})
